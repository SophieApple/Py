...
"font: 87 9pt \"Arial\";")
        ...
        self.pushButton_saveAll = QtWidgets.QPushButton(self.widget)
        self.pushButton_saveAll.setGeometry(QtCore.QRect(570, 20, 112, 24))
    ...
    def retranslateUi(self, MianWIndow):
        ...
        self.pushButton_save.setText(_translate("MianWIndow", "Save"))
